...
pygame.display.set_caption("Tembakan Balon - Projectgame")
...
pygame.mixer.init()
pygame.mixer.music.load('run-amok.mp3')
pygame.mixer.music.play(-1)


gambar = pygame.image.load('gambar.jpg')
...
class Balloon:
    ...
    def burst(self):
        ...
        if isonBalloon(self.x, self.y, self.a, self.b, pos):
            ...
            score += 1
            pop = pygame.mixer.Sound('tembak.ogg')
            pop.play()
            self.reset()
...
def showScore():
    scoreText = font.render("Score Tembakan : " + str(score), True, white)
    display.blit(scoreText, (100, height - lowerBound + 50))
